...
const Home = (props) => (
  <div>
    <Segment vertical style={{ border: 'none', paddingTop: '3rem', paddingBottom: '0rem' }}>
    ...
    <Segment vertical style={{ backgroundColor: '#f5f9fb', paddingBottom: '7em' }}>
      <Container textAlign='center'>
        <Header size='large' style={{ marginTop: '1.25rem', marginBottom: '0rem' }}>
          What do you need done?
        </Header>
        <Button animated='vertical' style={{ border: 'none', background: '#f5f9fb', paddingTop: '0' }}>
    ...
    <Segment vertical style={{ backgroundColor: '#0798bf', paddingTop: '8em', paddingBottom: '8em' }}>
      ...
      <Grid container stackable centered columns={3} style={{ marginTop: '1em' }}>
        { processes.map((process) => (
          <Grid.Column key={`${process.src}uniqko`}>
            ...
            <div style={{ textAlign: 'center', color: 'whitesmoke' }}>
              <div style={{ fontSize: '13pt' }}>{process.title}</div>
